...
function hfun_m1fill(vname)
  var = vname[1]
  return pagevar("optimization", var)
end
```

Which you can use like this `{{m1fill title}}`: **{{m1fill title}}**. Of course  in this specific case you could also have used `{{fill title optimization}}`: **{{fill title optimization}}**.
...
For instance you can use it to customise how [tag pages look like](/julia_programing/#customising_tag_pages).
